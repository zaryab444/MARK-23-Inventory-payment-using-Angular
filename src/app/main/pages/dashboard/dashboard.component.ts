...
export class DashboardComponent implements OnInit, OnDestroy {
  ...
  public themeTransparentColor:any;
 ...
 constructor(
  ...
  ngOnInit(): void {
    ...
    this.themeTransparentColor = JSON.parse(localStorage.getItem('themeTransparentColor'));
    ...
    this.widgets = {
      widget2: {
          ...
          colors    : [
              {
                  borderColor    : (this.themeColor) ? this.themeColor : environment.themeColor,
                  backgroundColor: (this.themeColor) ? this.themeColor : environment.themeColor
              }
          ],
          options   : {
            tooltips: {
          ...
          colors   : [
              {
                  borderColor              : (this.themeColor) ? this.themeColor : environment.themeColor,
                  backgroundColor          : (this.themeColor) ? this.themeColor : environment.themeColor,
                  pointBackgroundColor     : (this.themeColor) ? this.themeColor : environment.themeColor,
                  pointHoverBackgroundColor: (this.themeColor) ? this.themeColor : environment.themeColor,
                  pointBorderColor         : '#ffffff',
                  pointHoverBorderColor    : '#ffffff'
              },
              {
                  borderColor              : (this.themeTransparentColor) ? this.themeTransparentColor : environment.themeTransparentColor,
                  backgroundColor          : (this.themeTransparentColor) ? this.themeTransparentColor : environment.themeTransparentColor,
                  pointBackgroundColor     : (this.themeTransparentColor) ? this.themeTransparentColor : environment.themeTransparentColor,
                  pointHoverBackgroundColor: (this.themeTransparentColor) ? this.themeTransparentColor : environment.themeTransparentColor,
                  pointBorderColor         : '#ffffff',
                  pointHoverBorderColor    : '#ffffff'
              }
          ],
 ...
 .then((res: any) => {
     if(res && !res.StatusCode){
         ...
         if(this.dashboardUserStats.GraphViewModel.AvgTransGraph.data.length >= 0 || this.dashboardUserStats.GraphViewModel.AvgTransGraph.data == null ){
            ...
            this.widgets.widget6.datasets[0].data =  this.dashboardUserStats.GraphViewModel.Decline.data
            this.widgets.widget7.datasets[0].data =  this.dashboardUserStats.GraphViewModel.Refund.data
            this.widgets.widget8.datasets[0].data =  this.dashboardUserStats.GraphViewModel.Void.data
            ...
            this.widgets.widget6.datasets[0].label =  this.dashboardUserStats.GraphViewModel.Decline.label
            this.widgets.widget7.datasets[0].label =  this.dashboardUserStats.GraphViewModel.Refund.label
            this.widgets.widget8.datasets[0].label =  this.dashboardUserStats.GraphViewModel.Void.label
            ...
            this.widgets.widget6.labels =  this.dashboardUserStats.GraphViewModel.Decline.days
            this.widgets.widget7.labels =  this.dashboardUserStats.GraphViewModel.Refund.days
            this.widgets.widget8.labels =  this.dashboardUserStats.GraphViewModel.Void.days
            this.showBars = true;
         }
